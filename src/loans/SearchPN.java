 ...
 * @author ROMIE
 */
public class SearchPN extends javax.swing.JDialog implements MouseListener {
     ...
     */
    public SearchPN(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchPN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SearchPN dialog = new SearchPN(new javax.swing.JFrame(), true);
...
//end of Instantiation
    ...
    private void setCaptureDataTable() {
        ...
        for (int i = 0; i < columnName.length; i++) {
            bankList.addColumn(columnName[i]);
        }
        ...
        TableColumn hidden1 = jTableBank.getColumnModel().getColumn(1);
        hidden1.setMinWidth(0);
        hidden1.setPreferredWidth(0);
        hidden1.setMaxWidth(0);
        
        TableColumn hidden2 = jTableBank.getColumnModel().getColumn(2);
    ...
    private void loadTableData() {
        ...
        for (int i = 0; i < loanLib.getData().size(); i++) {
            bankList.addRow((Vector) loanLib.getData().get(i));
        }
    }
    ...
    private void editClick(JTable table) {
        ...
        if (row == -1) {
            ...
            NewJInternalFramePayment.setId(Integer.parseInt(table.getValueAt(row, 0).toString()));
            NewJInternalFramePayment.setPn(table.getValueAt(row, 3).toString());
            NewJInternalFramePayment.setClientName(table.getValueAt(row, 2).toString());
            NewJInternalFramePayment.setClientId(Integer.parseInt(table.getValueAt(row, 1).toString()));
            NewJInternalFramePayment.setType(table.getValueAt(row, 4).toString());
