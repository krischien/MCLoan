 ...
 * @author ROMIE
 */
public class SearchClient extends javax.swing.JDialog implements MouseListener {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SearchClient dialog = new SearchClient(new javax.swing.JFrame(), true);
...
//end of Instantiation
    ...
    private void loadTableData() {
        ...
        for (int i = 0; i < clientLib.getData().size(); i++) {
            bankList.addRow((Vector) clientLib.getData().get(i));
        }
    }
    ...
    private void editClick(JTable table) {
        ...
        if (row == -1) {
            ...
            NewLoanApplicationDialog.setId(Integer.parseInt(table.getValueAt(row, 0).toString()));
            NewLoanApplicationDialog.setClientName(table.getValueAt(row, 2).toString() + " " + table.getValueAt(row, 3).toString() + " " + table.getValueAt(row, 4).toString());
